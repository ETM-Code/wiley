...
const api: BoardApi = {
  ...
  getProjects: () => ipcRenderer.invoke(IPC.projectsGet),
  openProject: (path?: string) => ipcRenderer.invoke(IPC.projectsOpen, { path }),
  ...
  onProjectChanged: (callback: (view: ProjectView) => void) => subscribe(IPC.projectsChanged, callback),
